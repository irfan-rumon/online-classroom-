...
<html lang="en">
  ...
  <body>
    ...
    <script src="/dashboard/js/jquery.min./dashboard/js"></script>
    <script src="/dashboard/js/popper./dashboard/js"></script>
    <script src="/dashboard/js/bootstrap.min./dashboard/js"></script>
    <script src="/dashboard/js/main./dashboard/js"></script>
  </body>
</html>