...
<html lang="en">
  ...
  <body>
      ...
      <div id="content" class="p-4 p-md-5 pt-5">
              ...
              <form action="{{ url('answer/store', $hw_id)  }}" method="POST">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                   <label for="room_code" class="form-label">Answer</label>
            
                   <input type="textarea" class="form-control" id="answer" name="answer"aria-describedby="room_code">
